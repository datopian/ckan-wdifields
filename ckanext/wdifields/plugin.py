...
class WdifieldsPlugin(p.SingletonPlugin, tk.DefaultDatasetForm):
    ...
    def create_package_schema(self):
        ...
        schema.update(
            {'update_interval_months': [tk.get_validator('ignore_missing'), tk.get_converter('convert_to_extras')]})
        # our custom field
        schema.update({
    ...
    def show_package_schema(self):
        ...
        schema.update(
            {'update_interval_months': [tk.get_converter('convert_from_extras'), tk.get_validator('ignore_missing')]})
        schema.update({
